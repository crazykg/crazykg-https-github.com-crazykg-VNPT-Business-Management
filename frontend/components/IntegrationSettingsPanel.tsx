    ...
    <div className="p-4 md:p-8 pb-20 md:pb-8">
      <header className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6 md:mb-8 animate-fade-in">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Quản trị kết nối Google Drive cho upload tài liệu sản phẩm.</p>
        </div>
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 bg-white border border-slate-200 hover:bg-slate-50 transition-all text-slate-600 px-4 py-2.5 rounded-lg font-bold text-sm shadow-sm disabled:opacity-60"
          >
          ...
          <button
            ...
            disabled={isLoading || isSaving || isTesting}
            className="flex items-center gap-2 bg-primary hover:bg-deep-teal transition-all text-white px-5 py-2.5 rounded-lg font-bold text-sm shadow-md shadow-primary/20 disabled:opacity-60"
          >
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden animate-fade-in">
        <div className="px-5 py-4 border-b border-slate-100 flex flex-wrap items-center gap-3">
          ...
          <span className="text-xs text-slate-500">
            Nguồn cấu hình: <strong>{settings?.source || 'ENV'}</strong>
          </span>
        </div>
