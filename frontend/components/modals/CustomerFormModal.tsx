            ...
            <div data-customer-field="customer_code">
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className={`w-full h-11 px-4 rounded-lg border bg-white text-slate-900 focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all placeholder:text-slate-400 ${errors.customer_code ? 'border-red-500 ring-1 ring-red-500' : 'border-slate-300'}`}
                />
                <p className="text-xs text-slate-500">Để trống hệ thống tự sinh theo Tên khách hàng.</p>
                {errors.customer_code ? <p className="text-xs text-red-500 mt-0.5">{errors.customer_code}</p> : null}
              </div>
            </div>
