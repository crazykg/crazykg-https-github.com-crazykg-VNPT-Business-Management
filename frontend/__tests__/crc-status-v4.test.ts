...
describe('STATUS_COLOR_MAP', () => {
  ...
  it('keeps runtime-visible intake labels aligned with the current workflow copy', () => {
    ...
    expect(STATUS_COLOR_MAP['dms_task_created'].label).toBe('Tạo task DMS');
...
describe('phase 2 transition option adapter', () => {
  it('keeps backend-visible options when dispatcher intake has no synthetic decision metadata', () => {
    const allTargets = [
