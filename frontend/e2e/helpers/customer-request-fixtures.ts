...
export function buildCustomerRequestScenarioState(): MockCustomerRequestScenarioState {
  ...
  const cases: MockCustomerRequestCase[] = [
    ...
    {
      id: 107,
      request_code: 'CRC-202603-0107',
      summary: 'Ca đang ở bước phân tích sau khi PM đã giao việc',
      description: 'Performer đã nhận đầu vào và đang phân tích hướng xử lý trước khi triển khai.',
      customer_id: 21,
      customer_name: 'Bệnh viện Số 2',
      customer_personnel_id: 31,
      customer_personnel_name: 'Trần Thị B',
      ...
      dispatcher_name: 'PM Lan',
      performer_user_id: 3,
      performer_name: 'Dev Bình',
      current_status_code: 'analysis',
      estimated_hours: 8,
      total_hours_spent: 2.5,
      sla_due_at: '2026-03-24 17:00:00',
      completed_at: null,
      ...
      status_rows: {
        analysis: {
          performer_user_id: 3,
          analysis_content: 'Đã rà soát log và chốt cần triển khai thêm script đồng bộ.',
        },
      },
      attachments: [
        {
          id: 504,
          fileName: 'phan-tich-nguyen-nhan.docx',
          file_name: 'phan-tich-nguyen-nhan.docx',
          fileUrl: 'https://example.test/phan-tich-nguyen-nhan.docx',
          file_url: 'https://example.test/phan-tich-nguyen-nhan.docx',
      ...
      ref_tasks: [
        {
          id: 704,
          task_code: 'IT360-0107',
          task_link: 'https://it360.example.test/107',
          task_source: 'IT360',
      ...
      estimates: [
        {
          id: 805,
          request_case_id: 107,
          status_code: 'analysis',
          estimated_hours: 8,
          estimate_scope: 'total',
          estimate_type: 'manual',
          note: 'Estimate sau bước rà soát đầu vào',
          estimated_by_user_id: 2,
          estimated_by_name: 'PM Lan',
          estimated_at: '2026-03-20 11:15:00',
        },
      ],
      worklogs: [
        buildWorklogEntry(905, 107, 'Rà soát log và xác định hướng fix cho ca NOC.', 2.5, '2026-03-21', 'analysis', 'Dev Bình'),
      ],
      timeline: [
        buildTimelineEntry(1007, 107, 'analysis', 'Phân tích', '2026-03-21 09:20:00', 'PM Lan'),
      ],
    },
    {
      id: 108,
      request_code: 'CRC-202603-0108',
      summary: 'Ca phân tích sẵn sàng chuyển DMS',
      description: 'Ca đã có kết luận cần chuyển gói dữ liệu sang DMS để xử lý tiếp.',
      customer_id: 20,
      customer_name: 'VNPT Hà Nội',
      customer_personnel_id: 30,
      customer_personnel_name: 'Nguyễn Văn A',
      ...
      estimated_hours: 5,
      total_hours_spent: 1,
      sla_due_at: '2026-03-25 17:00:00',
      completed_at: null,
      created_at: '2026-03-20 13:00:00',
      updated_at: '2026-03-21 09:25:00',
      status_rows: {
        analysis: {
          performer_user_id: 1,
          analysis_content: 'Đã xác định cần chuyển hồ sơ sang DMS để đồng bộ tiếp.',
        },
      },
      attachments: [],
      ref_tasks: [
        {
          id: 705,
          task_code: 'REF-108',
          task_link: 'https://ref.example.test/108',
          task_source: 'REFERENCE',
          task_status: 'READY',
        },
      ],
      estimates: [
        {
          ...
          estimate_scope: 'total',
          estimate_type: 'manual',
          note: 'Estimate cho nhánh DMS',
          estimated_by_user_id: 1,
          estimated_by_name: 'Smoke Tester',
          estimated_at: '2026-03-20 13:10:00',
        },
      ],
      worklogs: [
        buildWorklogEntry(906, 108, 'Kiểm tra dữ liệu đầu vào trước khi chuyển DMS.', 1, '2026-03-21', 'analysis'),
      ],
      timeline: [
        buildTimelineEntry(1008, 108, 'analysis', 'Phân tích', '2026-03-21 09:25:00', 'Smoke Tester'),
      ],
    },
  ];
