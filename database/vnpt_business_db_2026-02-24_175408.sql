-- ===============================================
-- UPDATE LOG
-- Exported from MySQL database: vnpt_business_db
-- Exported at: 2026-02-27 17:38:20 +07
-- Source host: 127.0.0.1:3306
-- Command: mysqldump --single-transaction --routines --triggers --set-gtid-purged=OFF
-- File overwritten by Codex per user request
-- ===============================================
...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng 35: Lịch sử Audit'
...
CREATE TABLE `support_request_history` (
  ...
  `new_status` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NEW',
...
-- Dump completed on 2026-02-27 17:38:03
