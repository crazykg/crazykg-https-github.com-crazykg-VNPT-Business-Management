...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng 35: Lịch sử Audit'
...
CREATE TABLE `migrations` (
  ...
  `batch` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng 1: Quản lý vết migration';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `support_request_history` (
  ...
  `old_status` enum('OPEN','HOTFIXING','RESOLVED','DEPLOYED','PENDING','CANCELLED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `new_status` enum('OPEN','HOTFIXING','RESOLVED','DEPLOYED','PENDING','CANCELLED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng 38: Nhật ký thay đổi trạng thái Task';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `support_request_history` VALUES (20,2428613,'CANCELLED','RESOLVED',NULL,'2026-02-26 07:14:00',1),(21,2432033,'CANCELLED','HOTFIXING',NULL,'2026-02-26 07:14:13',1),(22,2432033,'HOTFIXING','OPEN',NULL,'2026-02-26 07:14:21',1),(23,2430513,'CANCELLED','RESOLVED',NULL,'2026-02-26 07:14:27',1),(24,2429473,'CANCELLED','PENDING',NULL,'2026-02-26 07:14:40',1),(25,2450776,'CANCELLED','DEPLOYED',NULL,'2026-02-26 07:15:49',1),(26,2450776,'DEPLOYED','HOTFIXING',NULL,'2026-02-26 07:16:08',1),(27,2448876,'CANCELLED','DEPLOYED',NULL,'2026-02-26 07:18:09',1),(28,2450776,'HOTFIXING','RESOLVED',NULL,'2026-02-26 07:19:27',1),(29,2315712,'CANCELLED','OPEN',NULL,'2026-02-26 07:23:06',1),(30,2449536,'CANCELLED','OPEN',NULL,'2026-02-26 07:24:32',1),(31,2449156,'CANCELLED','DEPLOYED',NULL,'2026-02-26 07:26:25',1);
...
-- Dump completed on 2026-02-27  6:11:26
-- MySQL dump 10.13  Distrib 9.6.0, for macos26.2 (arm64)
--
-- Host: 127.0.0.1    Database: vnpt_business_db
-- ------------------------------------------------------
...
CREATE TABLE `support_requests` (
  ...
  `status` enum('OPEN','HOTFIXING','RESOLVED','DEPLOYED','PENDING','CANCELLED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'OPEN',
  ...
  `change_log` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Hướng xử lý / Ghi chú kỹ thuật',
  `test_note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Kết quả kiểm thử',
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `created_by` bigint unsigned DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
) ENGINE=InnoDB AUTO_INCREMENT=2457469 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Bảng 37: Quản lý Task hỗ trợ chi tiết';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
--
-- WHERE:  1 ORDER BY id DESC LIMIT 20

LOCK TABLES `support_requests` WRITE;
/*!40000 ALTER TABLE `support_requests` DISABLE KEYS */;
INSERT INTO `support_requests` VALUES (2451085,'SRQ-0001499091','Seed yêu cầu hỗ trợ #1499091',1,1,1,1,1,'Reporter 0091',1,'RESOLVED','HIGH','2025-04-21','2025-04-27','2025-04-23',NULL,'2025-04-26','https://jira.vnpt.local/browse/SRQ-0001499091','Auto seed log #1499091','Auto seed test note #1499091','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451084,'SRQ-0001499092','Seed yêu cầu hỗ trợ #1499092',1,1,1,1,1,'Reporter 0092',1,'DEPLOYED','URGENT','2025-04-22','2025-04-29','2025-04-25',NULL,'2025-04-28','https://jira.vnpt.local/browse/SRQ-0001499092','Auto seed log #1499092','Auto seed test note #1499092','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451083,'SRQ-0001499093','Seed yêu cầu hỗ trợ #1499093',1,1,1,1,1,'Reporter 0093',1,'PENDING','LOW','2025-04-23','2025-05-01',NULL,NULL,NULL,'https://jira.vnpt.local/browse/SRQ-0001499093','Auto seed log #1499093','Auto seed test note #1499093','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451082,'SRQ-0001499094','Seed yêu cầu hỗ trợ #1499094',1,1,1,1,1,'Reporter 0094',1,'CANCELLED','MEDIUM','2025-04-24','2025-05-03',NULL,NULL,NULL,'https://jira.vnpt.local/browse/SRQ-0001499094','Auto seed log #1499094','Auto seed test note #1499094','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451081,'SRQ-0001499095','Seed yêu cầu hỗ trợ #1499095',1,1,1,1,1,'Reporter 0095',1,'OPEN','HIGH','2025-04-25','2025-05-05',NULL,NULL,NULL,'https://jira.vnpt.local/browse/SRQ-0001499095','Auto seed log #1499095','Auto seed test note #1499095','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451080,'SRQ-0001499096','Seed yêu cầu hỗ trợ #1499096',1,1,1,1,1,'Reporter 0096',1,'HOTFIXING','URGENT','2025-04-26','2025-05-07',NULL,'2025-04-28',NULL,'https://jira.vnpt.local/browse/SRQ-0001499096','Auto seed log #1499096','Auto seed test note #1499096','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451079,'SRQ-0001499097','Seed yêu cầu hỗ trợ #1499097',1,1,1,1,1,'Reporter 0097',1,'RESOLVED','LOW','2025-04-27','2025-05-09','2025-05-05',NULL,'2025-05-08','https://jira.vnpt.local/browse/SRQ-0001499097','Auto seed log #1499097','Auto seed test note #1499097','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451078,'SRQ-0001499098','Seed yêu cầu hỗ trợ #1499098',1,1,1,1,1,'Reporter 0098',1,'DEPLOYED','MEDIUM','2025-04-28','2025-05-11','2025-05-07',NULL,'2025-05-10','https://jira.vnpt.local/browse/SRQ-0001499098','Auto seed log #1499098','Auto seed test note #1499098','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451077,'SRQ-0001499099','Seed yêu cầu hỗ trợ #1499099',1,1,1,1,1,'Reporter 0099',1,'PENDING','HIGH','2025-04-29','2025-05-13',NULL,NULL,NULL,'https://jira.vnpt.local/browse/SRQ-0001499099','Auto seed log #1499099','Auto seed test note #1499099','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451076,'SRQ-0001499100','Seed yêu cầu hỗ trợ #1499100',1,1,1,1,1,'Reporter 0100',1,'CANCELLED','URGENT','2025-04-30','2025-05-15',NULL,NULL,NULL,'https://jira.vnpt.local/browse/SRQ-0001499100','Auto seed log #1499100','Auto seed test note #1499100','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451075,'SRQ-0001499081','Seed yêu cầu hỗ trợ #1499081',1,1,1,1,1,'Reporter 0081',1,'PENDING','LOW','2025-04-11','2025-04-28',NULL,NULL,NULL,'https://jira.vnpt.local/browse/SRQ-0001499081','Auto seed log #1499081','Auto seed test note #1499081','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451074,'SRQ-0001499082','Seed yêu cầu hỗ trợ #1499082',1,1,1,1,1,'Reporter 0082',1,'CANCELLED','MEDIUM','2025-04-12','2025-04-30',NULL,NULL,NULL,'https://jira.vnpt.local/browse/SRQ-0001499082','Auto seed log #1499082','Auto seed test note #1499082','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451073,'SRQ-0001499083','Seed yêu cầu hỗ trợ #1499083',1,1,1,1,1,'Reporter 0083',1,'OPEN','HIGH','2025-04-13','2025-05-02',NULL,NULL,NULL,'https://jira.vnpt.local/browse/SRQ-0001499083','Auto seed log #1499083','Auto seed test note #1499083','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451072,'SRQ-0001499084','Seed yêu cầu hỗ trợ #1499084',1,1,1,1,1,'Reporter 0084',1,'HOTFIXING','URGENT','2025-04-14','2025-05-04',NULL,'2025-04-16',NULL,'https://jira.vnpt.local/browse/SRQ-0001499084','Auto seed log #1499084','Auto seed test note #1499084','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451071,'SRQ-0001499085','Seed yêu cầu hỗ trợ #1499085',1,1,1,1,1,'Reporter 0085',1,'RESOLVED','LOW','2025-04-15','2025-05-06','2025-04-21',NULL,'2025-04-26','https://jira.vnpt.local/browse/SRQ-0001499085','Auto seed log #1499085','Auto seed test note #1499085','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451070,'SRQ-0001499086','Seed yêu cầu hỗ trợ #1499086',1,1,1,1,1,'Reporter 0086',1,'DEPLOYED','MEDIUM','2025-04-16','2025-04-17','2025-04-23',NULL,'2025-04-28','https://jira.vnpt.local/browse/SRQ-0001499086','Auto seed log #1499086','Auto seed test note #1499086','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451069,'SRQ-0001499087','Seed yêu cầu hỗ trợ #1499087',1,1,1,1,1,'Reporter 0087',1,'PENDING','HIGH','2025-04-17','2025-04-19',NULL,NULL,NULL,'https://jira.vnpt.local/browse/SRQ-0001499087','Auto seed log #1499087','Auto seed test note #1499087','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451068,'SRQ-0001499088','Seed yêu cầu hỗ trợ #1499088',1,1,1,1,1,'Reporter 0088',1,'CANCELLED','URGENT','2025-04-18','2025-04-21',NULL,NULL,NULL,'https://jira.vnpt.local/browse/SRQ-0001499088','Auto seed log #1499088','Auto seed test note #1499088','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451067,'SRQ-0001499089','Seed yêu cầu hỗ trợ #1499089',1,1,1,1,1,'Reporter 0089',1,'OPEN','LOW','2025-04-19','2025-04-23',NULL,NULL,NULL,'https://jira.vnpt.local/browse/SRQ-0001499089','Auto seed log #1499089','Auto seed test note #1499089','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL),(2451066,'SRQ-0001499090','Seed yêu cầu hỗ trợ #1499090',1,1,1,1,1,'Reporter 0090',1,'HOTFIXING','MEDIUM','2025-04-20','2025-04-25',NULL,'2025-04-22',NULL,'https://jira.vnpt.local/browse/SRQ-0001499090','Auto seed log #1499090','Auto seed test note #1499090','Seed benchmark dataset 1.5M rows','2026-02-26 06:16:17',1,'2026-02-26 06:16:17',1,NULL);
