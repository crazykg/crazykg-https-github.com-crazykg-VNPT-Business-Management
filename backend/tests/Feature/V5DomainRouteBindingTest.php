...
class V5DomainRouteBindingTest extends TestCase
{
    public function test_domain_routes_are_bound_to_domain_controllers(): void
    {
        $expectations = [
            ...
            ['GET', 'api/v5/support-service-groups', 'App\Http\Controllers\Api\V5\SupportConfigController@serviceGroups', 'permission:support_service_groups.read'],
            ...
            ['GET', 'api/v5/support_service_groups', 'App\Http\Controllers\Api\V5\SupportConfigController@serviceGroups', 'permission:support_service_groups.read'],
