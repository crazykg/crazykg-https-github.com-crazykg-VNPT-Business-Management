...
class V5DomainRouteBindingTest extends TestCase
{
    public function test_domain_routes_are_bound_to_domain_controllers(): void
    {
        $expectations = [
            ...
            ['GET', 'api/v5/integrations/telegram', 'App\Http\Controllers\Api\V5\IntegrationSettingsController@telegramSettings', 'permission:authz.manage'],
            ['PUT', 'api/v5/integrations/telegram', 'App\Http\Controllers\Api\V5\IntegrationSettingsController@updateTelegramSettings', 'permission:authz.manage'],
            ['POST', 'api/v5/integrations/telegram/test', 'App\Http\Controllers\Api\V5\IntegrationSettingsController@testTelegramSettings', 'permission:authz.manage'],
            ...
            ['GET', 'api/v5/contract-signer-masters', 'App\Http\Controllers\Api\V5\SupportConfigController@contractSignerMasters', 'permission:contracts.read'],
            ['GET', 'api/v5/contract-signer-masters', 'App\Http\Controllers\Api\V5\SupportConfigController@contractSignerMasters', 'permission:support_requests.read'],
            ['POST', 'api/v5/contract-signer-masters', 'App\Http\Controllers\Api\V5\SupportConfigController@storeContractSignerMaster', 'permission:contracts.write'],
            ['POST', 'api/v5/contract-signer-masters', 'App\Http\Controllers\Api\V5\SupportConfigController@storeContractSignerMaster', 'permission:support_requests.write'],
            ['PUT', 'api/v5/contract-signer-masters/{id}', 'App\Http\Controllers\Api\V5\SupportConfigController@updateContractSignerMaster', 'permission:contracts.write'],
            ['PUT', 'api/v5/contract-signer-masters/{id}', 'App\Http\Controllers\Api\V5\SupportConfigController@updateContractSignerMaster', 'permission:support_requests.write'],
            ...
            ['GET', 'api/v5/contract_signer_masters', 'App\Http\Controllers\Api\V5\SupportConfigController@contractSignerMasters', 'permission:contracts.read'],
            ['GET', 'api/v5/contract_signer_masters', 'App\Http\Controllers\Api\V5\SupportConfigController@contractSignerMasters', 'permission:support_requests.read'],
            ['POST', 'api/v5/contract_signer_masters', 'App\Http\Controllers\Api\V5\SupportConfigController@storeContractSignerMaster', 'permission:contracts.write'],
            ['POST', 'api/v5/contract_signer_masters', 'App\Http\Controllers\Api\V5\SupportConfigController@storeContractSignerMaster', 'permission:support_requests.write'],
            ['PUT', 'api/v5/contract_signer_masters/{id}', 'App\Http\Controllers\Api\V5\SupportConfigController@updateContractSignerMaster', 'permission:contracts.write'],
            ['PUT', 'api/v5/contract_signer_masters/{id}', 'App\Http\Controllers\Api\V5\SupportConfigController@updateContractSignerMaster', 'permission:support_requests.write'],
            ...
            ['DELETE', 'api/v5/payment-schedules/{id}', 'App\Http\Controllers\Api\V5\ContractController@destroyPaymentSchedule', 'permission:contracts.payments'],
