...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::hasColumn('contracts', 'effective_date') && Schema::hasColumn('contracts', 'sign_date')) {
            $startExpression = 'COALESCE(`effective_date`, `sign_date`)';
        } elseif (Schema::hasColumn('contracts', 'effective_date')) {
            $startExpression = '`effective_date`';
        } elseif (Schema::hasColumn('contracts', 'sign_date')) {
            $startExpression = '`sign_date`';
        }
            ...
            BEGIN
                ...
                IF v_start_date IS NULL THEN
                    SIGNAL SQLSTATE '45000'
                        SET MESSAGE_TEXT = 'Missing contract effective/sign date for payment generation.';
                END IF;
