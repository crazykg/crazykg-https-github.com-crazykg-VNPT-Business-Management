...
return new class extends Migration {
    private const TABLE = 'programming_request_worklogs';
    ...
    private const TARGET_INDEXES = [
        [
            'name' => 'idx_worklog_req_logged_id',
            'columns' => ['programming_request_id', 'logged_date', 'id'],
        ],
        [
            'name' => 'idx_worklog_req_phase',
            'columns' => ['programming_request_id', 'phase'],
        ],
        [
            'name' => 'idx_worklog_date',
            'columns' => ['logged_date'],
        ],
    ];
    ...
    public function up(): void
    {
        ...
        foreach (self::TARGET_INDEXES as $target) {
