...
class V5MasterDataLegacyService extends Controller
{
    ...
    {
        return app(\App\Services\V5\Domain\UserAccessDomainService::class)->roles();
    }

    public function permissions(): JsonResponse
    {
        return app(\App\Services\V5\Domain\UserAccessDomainService::class)->permissions();
    }

    public function userAccess(Request $request): JsonResponse
    {
        return app(\App\Services\V5\Domain\UserAccessDomainService::class)->userAccess($request);
    }

    public function updateUserRoles(Request $request, int $userId): JsonResponse
    {
        return app(\App\Services\V5\Domain\UserAccessDomainService::class)->updateUserRoles($request, $userId);
    }

    public function updateUserPermissions(Request $request, int $userId): JsonResponse
    {
        return app(\App\Services\V5\Domain\UserAccessDomainService::class)->updateUserPermissions($request, $userId);
    }

    public function updateUserDeptScopes(Request $request, int $userId): JsonResponse
    {
        return app(\App\Services\V5\Domain\UserAccessDomainService::class)->updateUserDeptScopes($request, $userId);
    }
