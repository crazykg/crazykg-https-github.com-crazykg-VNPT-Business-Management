...
final class WorkflowFlowResolver
{
    ...
    private function statusMap(): array
    {
        return [
            ...
            'CHO_DUYET' => ['flow_step' => 'GD1A', 'form_key' => 'support.cho_duyet'],
            'DA_DUYET' => ['flow_step' => 'GD1B', 'form_key' => 'support.da_duyet'],
            ...
            'TU_CHOI' => ['flow_step' => 'GD4A', 'form_key' => 'support.tu_choi'],
