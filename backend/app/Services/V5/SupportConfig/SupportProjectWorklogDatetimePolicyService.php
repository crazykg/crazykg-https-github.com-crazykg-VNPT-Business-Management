...
class SupportProjectWorklogDatetimePolicyService
{
    private const PROVIDER = 'PROJECT_WORKLOG_DATETIME_POLICY';
    ...
    public function updatePolicy(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            'project_worklog_datetime_enabled' => ['required', 'boolean'],
        ...
        $payload = [
            ...
            'is_enabled' => (bool) $validated['project_worklog_datetime_enabled'],
            'updated_at' => $now,
    ...
    public function isEnabled(): bool
    {
        ...
        return $record === null ? false : (bool) ($record->is_enabled ?? false);
    }
    ...
    private function serializePolicyRecord(?object $record): array
    {
        return [
            'provider' => self::PROVIDER,
            'project_worklog_datetime_enabled' => $record === null
                ? false
                : (bool) ($record->is_enabled ?? false),
